...
const RAW_CARDS = [
  ...
  },
  {
    ...
    keyword: "Поток",
    message:
      "Ресурс здесь не стоит на месте, а начинает течь к тебе живее и свободнее. Денежный поток усиливается там, где ты не только держишь ценность, но и позволяешь ей двигаться по верному руслу.",
    shadow: "Ты можешь пытаться удержать поток слишком жёстко и тем самым сама сужать путь, по которому к тебе приходит достаток.",
  ...
  },
  {
    ...
    keyword: "Признание",
    message:
      "Твой голос или твой труд начинают выходить дальше привычного круга и находить отклик. Здесь речь не просто о видимости, а о том моменте, когда мир начинает по-настоящему слышать и признавать твою ценность.",
    shadow: "Ты можешь мерить свою ценность только чужим откликом и забывать, что признание должно опираться на уже существующий внутренний стержень.",
