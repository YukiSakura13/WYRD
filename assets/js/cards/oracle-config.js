export const ORACLE_CONFIG = {
  paywallCopy: {
    ...
    "spread-3": {
      title: "Открыть путь",
      text: "Это только то, что видно сейчас. Прошлое и будущее уже шевелятся под вуалью, но лес пока удерживает их в тени.",
      cta: "Открыть путь",
    },
    "spread-5": {
      title: "Узнать, куда ведёт лес",
      text: "Ты увидела начало. Но это не вся история. Лес ещё скрывает узел, тайный слой и то, куда на самом деле ведёт этот путь.",
      cta: "Узнать, куда ведёт лес",
    },
  },
  toneWeightPresets: {
